...
class Model_Consulta extends CI_Model 
{
  ...
  //--------------SIAF-----------------------------------------------------------------------------------------------------------------------------
     ...
     function validacionAct_proy($CodigoUnico)//act_proy
	 {
    ...
    function ActividadProyectNombrei($CodigoUnico)//act_proy
	 {
	 ...
	 function proyecto_snip_nombre($CodigoUnico)//proyecto_snip_nombre
	 {
	 ...
	 function meta($CodigoUnico)//meta
	 {
		 $db_prueba = $this->load->database('SIAF', TRUE);
	  ...
	  function gastos($CodigoUnico)//proyecto_snip_nombre
	 {
		 $db_prueba = $this->load->database('SIAF', TRUE);
	 ...
	 function gastosAcumulados($CodigoUnico)
	 {
		 $db_prueba = $this->load->database('SIAF', TRUE);
	...
	function EliminarDataSIAFLocal($CodigoUnico)
	 ...
	 //impostar data nueva 
	 function insert_snip_nombre($proyecto_snip,$nombre,$codigo_literal,$tipo_proyecto)//proyecto_snip_nombre
	 {
